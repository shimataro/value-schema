...
const REGEXP_DOMAIN_IPV6_0 = `:(((:${REGEXP_COMPONENT_IPV6}){1,7})|((:${REGEXP_COMPONENT_IPV6}){0,5}:${REGEXP_DOMAIN_IPV4})|:)`;
const REGEXP_DOMAIN_IPV6_1 = `(${REGEXP_COMPONENT_IPV6}:){1}(((:${REGEXP_COMPONENT_IPV6}){1,6})|((:${REGEXP_COMPONENT_IPV6}){0,4}:${REGEXP_DOMAIN_IPV4})|:)`;
const REGEXP_DOMAIN_IPV6_2 = `(${REGEXP_COMPONENT_IPV6}:){2}(((:${REGEXP_COMPONENT_IPV6}){1,5})|((:${REGEXP_COMPONENT_IPV6}){0,3}:${REGEXP_DOMAIN_IPV4})|:)`;
const REGEXP_DOMAIN_IPV6_3 = `(${REGEXP_COMPONENT_IPV6}:){3}(((:${REGEXP_COMPONENT_IPV6}){1,4})|((:${REGEXP_COMPONENT_IPV6}){0,2}:${REGEXP_DOMAIN_IPV4})|:)`;
const REGEXP_DOMAIN_IPV6_4 = `(${REGEXP_COMPONENT_IPV6}:){4}(((:${REGEXP_COMPONENT_IPV6}){1,3})|((:${REGEXP_COMPONENT_IPV6}){0,1}:${REGEXP_DOMAIN_IPV4})|:)`;
const REGEXP_DOMAIN_IPV6_5 = `(${REGEXP_COMPONENT_IPV6}:){5}(((:${REGEXP_COMPONENT_IPV6}){1,2})|:${REGEXP_DOMAIN_IPV4}|:)`;
const REGEXP_DOMAIN_IPV6_6 = `(${REGEXP_COMPONENT_IPV6}:){6}(:${REGEXP_COMPONENT_IPV6}|${REGEXP_DOMAIN_IPV4}|:)`;
...
const REGEXP_DOMAIN_IP = `\\[(${REGEXP_DOMAIN_IPV4}|IPv6:${REGEXP_DOMAIN_IPV6})\\]`;
